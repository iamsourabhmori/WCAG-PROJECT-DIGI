...
//       // Ensure the Document tab is active
//       setActiveTab("document");

//       // Forward the proper event that DocumentTab listens for
//       window.dispatchEvent(
//         new CustomEvent("voiceCommand", { detail: "start transcription" })
//       );
...
//   // const handleTabChange: (tab: TabValue) => void = (tab) => {
//   //   setActiveTab(tab);
//   //   setDownloadFiles([]);
//   // };
...
//     if (tab === "audio" || tab === "video" || tab === "image" || tab === "document") {
//       setActiveTab(tab);
//       setDownloadFiles([]);
//     } else {
//       console.warn("Invalid tab received:", tab);
//     }
//   };
...
//------------------------------------------------Audio Video Image Transcription Working----------------------------------------------------------------------
...
// // Tab type
// type TabValue = "audio" | "video" | "image" | "document" | "Compliance Checker";
...
//             <TabsTrigger value="image" className="py-3">Image</TabsTrigger>
//             <TabsTrigger value="document" className="py-3">Document</TabsTrigger>
//             <TabsTrigger value="compliance" className="py-3">Compliance Checker</TabsTrigger>
//           </TabsList>
...
//       // 1) general broadcast used by Audio/Video/Image tabs
//       window.dispatchEvent(new Event("autoTranscribe"));

//       // 2) also send the voiceCommand event that DocumentTab expects
//       //    (keeps existing DocumentTab voice logic intact)
